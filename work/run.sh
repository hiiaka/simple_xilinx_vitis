...
v++ -c -t ${TARGET} --platform ${DEVICE} -k ${SRCNAME} -I../${SRC} ../${SRC}/${SRCNAME}.cpp -o ${SRCNAME}.xo
v++ -l -t ${TARGET} --platform ${DEVICE} ./${SRCNAME}.xo -o ${SRCNAME}.xclbin
v++ -p -t ${TARGET} --platform ${DEVICE} ./${SRCNAME}.xclbin --package.out_dir package --package.rootfs ${ROOTFS}/rootfs.ext4 --package.kernel_image ${ROOTFS}/Image
